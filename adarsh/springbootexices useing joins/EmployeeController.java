...
public class EmployeeController {
	...
	// this method is for adding the employee data
	// storing it in the database
	@PostMapping("/addemployee")
	public String addemploye(@Valid @RequestBody Employee employee, BindingResult result1, Model model) {
	...
	// this method is for updating the employee data
	// from the database
	@GetMapping("/updateEmployee/{id}")
	public String updateEmploye(@PathVariable("id") long id, @Valid @RequestBody Employee employee,
